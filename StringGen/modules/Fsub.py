        ...
        try:
            ...
            try:
                await bot.send_photo(
                    ...
                    caption=f"⌯ ʜᴇʏ {msg.from_user.mention} 🥀\n\n⌯ ꜰʀɪꜱᴛ ʏᴏᴜ ᴄᴀɴ ᴊᴏɪɴ [ッ ˢᶱᶫᵒ ᵀʳᵉᵉ](https://t.me/solotreee/141) ᴄʜᴀɴɴᴇʟ.\n\n⌯ ᴛʜɪꜱ ᴀᴅᴠᴀɴᴄᴇ ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ ʙᴏᴛ ɴᴏᴛ ɴᴇᴇᴅᴇᴅ ꜰᴏʀ <b><u>ᴀᴘᴋ_ɪᴅ</u></b> & <b><u>ᴀᴘɪ_ʜᴀꜱʜ</b></u>, ᴘᴜᴛ ʏᴏᴜʀ ᴍᴏʙɪʟᴇ ɴᴜᴍʙᴇʀ ɢᴇᴛ ʏᴏᴜʀ ꜱᴇꜱꜱɪᴏɴ ꜰᴀꜱᴛʟʏ.❄️",

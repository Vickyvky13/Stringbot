...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@solotreee"))
        else:
            ...
            await client.join_chat("solotreee")
    except KeyError:
        pass
    try:
